...
class PresmaKejuaraanTim extends Migration
{
	public function up()
	{
		$this->forge->addField([
            ...
            'insentif_max'       			=> ['type' => 'varchar', 'constraint' => 11],
		...
		$this->forge->createTable('presma_kejuaraan_tim');
	}

	public function down()
	{
		//
		$this->forge->dropTable('presma_kejuaraan_tim');
	}
}
