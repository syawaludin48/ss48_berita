                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= route_to('manage-content-kategori-save') ?>" method="post">
                            <?= csrf_field() ?>


                            <div class="form-group required mb-2">
                                <label class="form-label">Nama Content Kategori</label>
                                <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter content kategori" value="<?= old('name') ?>">
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable table-data" id="">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Nama Content Kategori</th>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="<?= route_to('manage-content-kategori-update') ?>" method="post">
                                            <?= csrf_field() ?>
                                            ...
                                            <div class="form-group required mb-2">
                                                <label class="form-label">Nama Content Kategori</label>
                                                <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter contetn kategori" value="<?= $r['nama_kategori'] ?>">
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i><?= session('errors.name') ?>
                                                </div> 
                                            </div>
                            ...
                            <div class="modal modal-blur fade" id="delete<?= $r['random'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= route_to('manage-content-kategori-delete') ?>" method="post">
                                        <?= csrf_field() ?>
