    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body border-bottom py-3">
                ...
                ?>
                <form action="/manage-update-content-website" method="post"  class="form form-horizontal" enctype="multipart/form-data" >
                    <?= csrf_field() ?>                    
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?php if(session('errors.nama_content')) : ?>is-invalid<?php endif ?>" name="nama_content"  value="<?= $r['nama_content']; ?>"  placeholder="Enter Nama Blog">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" class="form-control texteditor <?php if(session('errors.content_website')) : ?>is-invalid<?php endif ?>"  name="content_website" id="full"  placeholder="Enter Content Blog"><?= $r['content']; ?></textarea>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check">
                                <input class="form-check-input <?php if(session('errors.draf')) : ?>is-invalid<?php endif ?>" type="radio" name="draf" value="1" id="1" <?php if($r['draf'] == 1){echo 'checked';}else{} ?> >
                                <label class="form-check-label" for="1">Draf</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input <?php if(session('errors.draf')) : ?>is-invalid<?php endif ?>" type="radio" name="draf" value="0" id="2" <?php if($r['draf'] == 0){echo 'checked';}else{} ?>  >
                        ...
                        <div class="col-sm-9">
                            <select id="select2bs4" class="form-select py-2  <?php if(session('errors.content_kategori')) : ?>is-invalid<?php endif ?>" name="content_kategori" >
                                ...
                                <?php foreach($kategori as $k){ ?>
                                    <option value="<?= $k['id'] ?>" <?php if($r['kategori'] == $k['id']){echo 'selected';} ?> ><?= $k['nama_kategori'] ?></option>
                                <?php } ?>
                            </select>   
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row  mb-3">
                        ...
                        <?php 
                            $tgl = explode(' ',$r['created_at']);                        
                        ?>
                        <div class="col-sm-9">
                            <!-- <span class="text-primary font-weight-bold">Jika tanggal tidak di tentukan, maka akan sesuai tanggal sekarang !!!</span> -->
                            <input type="date" class="form-control <?php if(session('errors.tanggal')) : ?>is-invalid<?php endif ?>" name="tanggal"  value="<?= $tgl[0]; ?>"  placeholder="Enter Tanggal Post">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">                    
                            ...
                            <?php if($r['thumbnail'] <> '' and $r['thumbnail'] <> 'default.svg'){ ?>
                            <div class="w-100"></div>
                            <div class="mt-2">
                                <img src="<?= base_url('assets') ?>/images/content/thumbnail/<?= $r['thumbnail'] ?>" style="max-width:200px">
                            </div>
                            <?php } ?>   
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <button type="submit" class="btn btn-teal ml-1">Update Content</button>
