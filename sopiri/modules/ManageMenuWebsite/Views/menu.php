                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= route_to('manage-menu-website-save') ?>" method="post">
                            <?= csrf_field() ?>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="<?= route_to('manage-menu-website-update') ?>" method="post">
                                            <?= csrf_field() ?>
                            ...
                            <div class="modal modal-blur fade" id="delete<?= $r['random'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= route_to('manage-menu-website-delete') ?>" method="post">
                                        <?= csrf_field() ?>
