                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= route_to('manage-menu-group-save') ?>" method="post">
                            <?= csrf_field() ?>


                                <div class="form-group required mb-2">
                                    <label class="form-label">Nama Group Menu</label>
                                ...
                                <div class="form-group required mb-2">
                                    <label class="form-label">Manage Group Menu</label>
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable table-data" id="">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Nama Group Menu</th>
                                <th class="text-center">Manage Group Menu</th>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="<?= route_to('manage-menu-group-update') ?>" method="post">
                                            <?= csrf_field() ?>
                                            ...
                                            <div class="form-group required mb-2">
                                                <label class="form-label">Nama Group Menu</label>
                                                <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter nama menu" value="<?= $r['nama_group'] ?>">
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i><?= session('errors.name') ?>
                                                </div> 
                                            </div>
                            ...
                            <div class="modal modal-blur fade" id="delete<?= $r['random'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= route_to('manage-menu-group-delete') ?>" method="post">
                                        <?= csrf_field() ?>
