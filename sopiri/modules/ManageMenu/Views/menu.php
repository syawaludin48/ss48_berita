                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= route_to('manage-menu-save') ?>" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group required mb-2">
                                <label class="form-label">Group Menu</label>
                                    ...
                                    <select id="select" style="width:100%" class="form-select   <?php if(session('errors.id_group')) : ?>is-invalid<?php endif ?>" name="id_group" >
                                        <option value="">Please Select</option>
                                        <?php foreach($group_menu_select as $k){ ?>
                                        <option value="<?= $k['id'] ?>" <?php if(old('id_group') == $k['id']){echo 'selected';} ?> ><?= $k['nama_group'] ?></option>
                                        <?php } ?>
                                    </select> 
                                
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i><?= session('errors.id_group') ?>
                                </div> 
                            </div> 
                            <div class="form-group required mb-2">
                                <label class="form-label">Nama Menu</label>
                                <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter nama menu" value="<?= old('name') ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group required mb-2">
                                <label class="form-label">Manage Menu</label>
                                <input type="text" class="form-control <?php if(session('errors.manage')) : ?>is-invalid<?php endif ?>" id="manage" name="manage" placeholder="Enter nama menu" value="<?= old('manage') ?>">
                                <div class="invalid-feedback">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="<?= route_to('manage-menu-update') ?>" method="post">
                                            <?= csrf_field() ?>
                                            ...
                                            <div class="form-group required mb-2">
                                                ...
                                                <select id="" class="form-select py-2  <?php if(session('errors.id_group')) : ?>is-invalid<?php endif ?>" name="id_group" >
                                                    <option value="">Please Select</option>
                                                    <?php foreach($group_menu_select as $k){ ?>
                                                        <?php if($r['id_group'] == $k['id']){ ?>
                                                            <option value="<?= $k['id'] ?>" selected  ><?= $k['nama_group'] ?></option>
                                                        <?php }else{ ?>
                                            ...
                                            <div class="form-group required mb-2">
                                                <label class="form-label">Nama Menu</label>
                                                <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter nama menu" value="<?= $r['nama_menu'] ?>">
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i><?= session('errors.name') ?>
                                                </div> 
                                            </div>
                                            <div class="form-group required mb-2">
                                                <label class="form-label">Link Menu</label>
                                                <input type="text" class="form-control <?php if(session('errors.link')) : ?>is-invalid<?php endif ?>" id="link" name="link" placeholder="Enter link menu" value="<?= $r['link_menu'] ?>">
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i><?= session('errors.link') ?>
                                                </div> 
                                            </div> 
                                            <div class="form-group required mb-2">
                                                <label class="form-label">Manage Menu</label>
                                                <input type="text" class="form-control <?php if(session('errors.manage')) : ?>is-invalid<?php endif ?>" id="manage" name="manage" placeholder="Enter nama menu" value="<?= $r['manage'] ?>">
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i><?= session('errors.manage') ?>
                                                </div> 
                                            </div> 
                                            ...
                                            <div class="form-group required mb-2">
                                                <label class="form-label">Nomor Urut ( a - z )</label>
                                                <input type="text" class="form-control <?php if(session('errors.nomor')) : ?>is-invalid<?php endif ?>" id="nomor" name="nomor" placeholder="Enter Nomor Urut" value="<?= $r['no_urut'] ?>">
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i><?= session('errors.nomor') ?>
                                                </div> 
                                            </div>   
                            ...
                            <div class="modal modal-blur fade" id="delete<?= $r['random'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= route_to('manage-menu-delete') ?>" method="post">
                                        <?= csrf_field() ?>
