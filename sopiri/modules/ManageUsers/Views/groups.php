                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group required mb-2">
                                <label class="form-label">Nama Groups</label>
                                <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter name groups" value="<?= old('name'); ?>">
                            ...
                            <div class="form-group required mb-2">
                                ...
                                <input type="text" class="form-control <?php if(session('errors.description')) : ?>is-invalid<?php endif ?>" id="description" name="description" placeholder="Enter description groups" value="<?= old('description'); ?>">
                                <div class="invalid-feedback">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" class="form-control" id="id_groups" name="id_groups" value="<?= $r['id'] ?>">

                                                <div class="form-group required mb-2">
                                                    <label class="form-label">Nama Groups</label>
                                                    <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" placeholder="Enter name groups" value="<?= $r['name'] ?>">
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i><?= session('errors.name') ?>
                                                    </div> 
                                                </div>
