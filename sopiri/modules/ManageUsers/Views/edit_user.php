    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body border-bottom py-3">
                ...
                <?php $r = $users; ?>
                <form action="/manage-update-users" method="post"  class="form form-horizontal" enctype="multipart/form-data" >
                    <?= csrf_field() ?>

                    <input type="hidden"  class="form-control" name="random"  value="<?= $r['random']; ?>" >

                    <div class="form-group row required mb-3">
                        <label  class="form-label col-sm-3 col-form-label">Nama Lengkap </label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?php if(session('errors.fullname')) : ?>is-invalid<?php endif ?>" name="fullname"  value="<?= $r['fullname']; ?>"  placeholder="Enter fullname">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  class="form-control <?php if(session('errors.email')) : ?>is-invalid<?php endif ?>" name="email"  value="<?= $r['email']; ?>" placeholder="E-mail" >
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?php if(session('errors.username')) : ?>is-invalid<?php endif ?>" name="username"  value="<?= $r['username']; ?>"  placeholder="Enter Username">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control <?php if(session('errors.password')) : ?>is-invalid<?php endif ?>" name="password"  value="<?= old('password'); ?>"  placeholder="Masukan password baru jika ubah password">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            <select id="select2bs4" class="form-select py-2  <?php if(session('errors.groups_access')) : ?>is-invalid<?php endif ?>" name="groups_access" >
                                ...
                                <option value="<?= $k['id'] ?>" <?php if($r['group_id'] == $k['id']){echo 'selected';} ?> ><?= $k['name'] ?> - <?= $k['description'] ?></option>
                                <?php } ?>
                            </select>   
                            <div class="invalid-feedback">
                    ...
                    <div class="mt-4">
                        ...
                        <button type="submit" class="btn btn-teal ml-1">Update Users</button>
