    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body border-bottom py-3">
                ...
                <form action="/manage-galeri-master-save" method="post"  class="form form-horizontal" enctype="multipart/form-data" >
                    <?= csrf_field() ?>                    

                    <div class="form-group row required mb-3">
                        <label for="inputPassword" class="form-label col-sm-3 col-form-label">Nama Galeri</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?php if(session('errors.nama_galeri')) : ?>is-invalid<?php endif ?>" name="nama_galeri"  value="<?= old('nama_galeri'); ?>"  placeholder="Enter Nama Galeri">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            <select id="select2bs42" class="form-label form-select <?php if(session('errors.kategori')) : ?>is-invalid<?php endif ?>" name="kategori" >
                                ...
                                <option value="<?= $k['id'] ?>" <?php if(old('kategori') == $k['id']){echo 'selected';} ?> ><?= $k['nama_kategori'] ?></option>
                                <?php } ?>
                            </select>   
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row required mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check">
                                <input class="form-check-input <?php if(session('errors.status')) : ?>is-invalid<?php endif ?>" type="radio" name="status" value="1" id="1" >
                                <label class="form-check-label" for="1">Non Aktif</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input <?php if(session('errors.status')) : ?>is-invalid<?php endif ?>" type="radio" name="status" value="0" id="2" >
                    ...
                    <div class="mt-4">
                        ...
                        <button type="submit" class="btn btn-primary ml-1">Tambah Galeri Master</button>
